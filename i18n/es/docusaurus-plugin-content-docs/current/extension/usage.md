...
title: Guía de extensión AI one - Barra lateral y atajos
description: Domina la extensión AI one! Activa la barra lateral con Alt+Shift+S.
---

# ¿Cómo usar la extensión del navegador?

Chat instructions soporta 13 idiomas principales. El idioma de la extensión se configura automáticamente según tu navegador. También puedes cambiarlo manualmente en la página de configuración.
