...
title: AI one एक्सटेंशन गाइड - साइडबार और शॉर्टकट
description: AI one ब्राउज़र एक्सटेंशन में महारत हासिल करें! Alt+Shift+S से साइडबार सक्रिय करें।
---

# ब्राउज़र एक्सटेंशन का उपयोग कैसे करें?

Chat instructions 13 प्रमुख भाषाओं का समर्थन करता है। एक्सटेंशन की भाषा आपके ब्राउज़र के अनुसार स्वचालित रूप से सेट होती है। आप सेटिंग्स में मैन्युअल रूप से भी बदल सकते हैं।
